...
for indSub=1:sy
    ...
    if ~exist(['Z:\RERC- Phones\Server Data\Sorted Data\' ID], 'dir')
        mkdir(['Z:\RERC- Phones\Server Data\Sorted Data\' ID])
    end
    ...
    for indAct=1:length(Activities)
        ...
        if ~exist(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity], 'dir')
            mkdir(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity])
        end

        %% Read File and Separate Data by Sensor

        if ~exist(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Acc'], 'dir')
            mkdir(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Acc'])
        end

        if ~exist(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Gyr'], 'dir')
            mkdir(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Gyr'])
        end

        if ~exist(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Bar'], 'dir')
            mkdir(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Bar'])
        end
        ...
        parfor indFile=1:length(filenames)
            ...
            %% Save Files
            dlmwrite(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Acc\Acc_' Num '.csv'], Acc, 'Precision', 7)
            dlmwrite(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Gyr\Gyr_' Num '.csv'], Gyr, 'Precision', 7)
            dlmwrite(['Z:\RERC- Phones\Server Data\Sorted Data\' ID '\' Activity '\Bar\Bar_' Num '.csv'], Bar, 'Precision', 7)
