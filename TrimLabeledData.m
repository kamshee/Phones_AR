...
%     r=.2*std(Data(:,ax));
    ...
    if ind<4
        ...
        if isempty(X)
            csvwrite([dirname 'TrimmedData\Acc\' Subject '_' Activity '_' Num '.csv'],AccData)
            csvwrite([dirname 'TrimmedData\Gyr\' Subject '_' Activity '_' Num '.csv'],GyrData)
            csvwrite([dirname 'TrimmedData\Bar\' Subject '_' Activity '_' Num '.csv'],BarData)
            continue
        end
...
%             dummy=1;
    ...
    csvwrite([dirname 'TrimmedData\Acc\' Subject '_' Activity '_' Num '.csv'],newAccData)
    csvwrite([dirname 'TrimmedData\Gyr\' Subject '_' Activity '_' Num '.csv'],newGyrData)
    csvwrite([dirname 'TrimmedData\Bar\' Subject '_' Activity '_' Num '.csv'],newBarData)
end
